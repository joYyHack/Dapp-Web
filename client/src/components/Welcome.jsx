...
const CommonStyles =
  "min-h-[70px] sm:px-0 px-2 sm:min-w-[95px] flex justify-center items-center border-[0.5px] border-gray-400 text-sm font-light text-white hover:bg-sky-900 ease-in duration-100";
    ...
    <div className="flex justify-center items-center w-full">
      <div className="text-white flex flex-col mf:flex-row items-start justify-between md:p-20 py-12 px-4">
        <div className="text-left text-xl flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <p className="text-base font-light md:w-9/12 w-11/12">
            Explore crypto world by AG Service
          </p>

          <button
            type="button"
            onClick={ConnectWallet}
            className="flex flex-row justify-center item-center my-5 bg-sky-500 p-3 rounded-full cursor-pointer hover:bg-sky-800 ease-linear duration-100"
          >
